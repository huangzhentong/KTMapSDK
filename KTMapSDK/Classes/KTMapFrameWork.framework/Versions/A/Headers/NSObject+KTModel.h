 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `KTModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface KTAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation KTAuthor
     @end
 
     @interface KTBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) KTAuthor *author;
     @end
     @implementation KTBook
     @end
    
     int main() {
         // create model from json
         KTBook *book = [KTBook KT_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book KT_modelToJSONString];
     ...
     ********************** Coding/Copying/hash/equal *********************
     ...
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self KT_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self KT_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self KT_modelCopy]; }
     - (NSUInteger)hash { return [self KT_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self KT_modelIsEqual:object]; }
     @end
 ...
 */
+ (nullable instancetype)KT_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "KTKT-MM-dd'T'HH:mm:ssZ", "KTKT-MM-dd HH:mm:ss" or "KTKT-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)KT_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)KT_modelToJSONObject;
 ...
 */
- (nullable NSData *)KT_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)KT_modelToJSONString;
 ...
 */
+ (nullable NSArray *)KT_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (KTModel)
 ...
 */
+ (nullable NSDictionary *)KT_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<KTModel>' to your class header.
 */
@protocol KTModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class KTShadow, KTBorder, KTAttachment;
 
        @interface KTAttributes
        @property NSString *name;
        ...
        @implementation KTAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [KTShadow class],
                     @"borders" : KTBorder.class,
...
/**
 ...
 Example:
        @class KTCircle, KTRectangle, KTLine;
 
        @implementation KTShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [KTCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [KTRectangle class];
